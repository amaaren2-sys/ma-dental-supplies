...
async function getProducts(params=""){
  ...
  let query=sb.from("products").select("id,name,slug,brand,category,price,stock,rating,icon,image_url,description,featured").order("created_at",{ascending:false});
